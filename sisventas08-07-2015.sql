...
insert  into `caracfisicas`(`id`,`dimencion`,`peso`,`color`,`estado`) values (1,'141','41','BLUE',0),(2,'12CMX15CMX25CM','124G','FF408080',0);
...
insert  into `tipodescuento`(`id`,`nombre`,`porcentaje`,`estado`) values (1,'DESCUENTO NAVIDEÑO',10,0);
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `busca_descuento`(pCriterio char(20))
BEGIN
	...
	THEN 
		SELECT documento, razon FROM proveedor ORDER BY razon;
