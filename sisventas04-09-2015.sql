...
insert  into `cliente`(`documento`,`razon`,`telefono`,`direccion`,`fechaRegistro`,`email`,`estado`) values ('10404942501','EDGARD RAYME','','AV. LA CULTURA 772','2015-09-02','',0);
...
BEGIN
    ...
    SELECT id, nombre, precio, stock, stockminimo FROM producto WHERE nombre=pFiltro OR nroserie=pFiltro;
END */$$
DELIMITER ;
