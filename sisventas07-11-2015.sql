...
insert  into `descuento`(`id`,`criterio`,`idProducto`,`nomProducto`,`idTipoDescuento`,`nomDescuento`,`fechaInicio`,`fechaFin`,`estado`) values (1,'PRODUCTO','4','CHOMPA DE LANA',2,'DESCUENTO DE 10%','2015-09-07','2015-09-30',0),(2,'CATEGORIA','1','SIN CATEGORIA',3,'DESCUENTO 02','2015-09-07','2015-09-29',0),(3,'PROVEEDOR','45454545454','CUSCO HOSTING',1,'DESCUENTO NAVIDEÃ‘O','2015-09-07','2015-09-29',0);
