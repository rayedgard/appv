...
insert  into `usuario`(`dni`,`nombre`,`apaterno`,`amaterno`,`sexo`,`nick`,`pass`,`telefono`,`direccion`,`nacimiento`,`privilegio`,`estado`) values (11111111,'FDTDFF','FFFFFF','GYHHH','M','ghhg','ffff','45444444','FFFFF','2015-06-29',1,0),(40494250,'edgard','rayme','quispe','m','edgard','1234','1452632','cusco','2015-06-09',0,0);
...
BEGIN
    ...
    WHERE nick = pIdUsuario AND pass = pPassword;
