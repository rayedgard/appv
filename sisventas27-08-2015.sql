...
insert  into `tipocomprobante`(`id`,`nombre`,`estado`) values (1,'BOLETA',0),(2,'FACTURA',0),(3,'NOTA DE PEDIDO',1),(4,'TICKET',0);
...
insert  into `tipotarjeta`(`id`,`nombre`,`estado`) values (1,'VISA',0),(2,'MASTER CARD',0),(3,'AMERICAN EXPRESS',0),(4,'XXXXXXX',0);
