...
namespace app
{
    public partial class frmClientes : Form
    {
        ...
        public frmClientes(string ArchivoCOnfig)
        {
            InitializeComponent();
        ...
        private void listar()
        {
            ...
            DataSet datos = ConexionBD.EjecutarProcedimientoReturnDataSet("cliente_lista");
        ...
        private void dgvDatos_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if ((e.RowIndex >= 0) && ((e.ColumnIndex == 0) || (e.ColumnIndex == 1)))
            {
                ...
                {//ELIMINAR
                    if (MessageBox.Show("¿ESTA SEGURO DE ELIMINAR ESTE CLIENTE? \r", "CUIDADO!!!", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Warning) == DialogResult.Yes)
                    {
                        //LimpiarDatosHorario();
                        ConexionBD.Conectar(true, string_ArchivoConfiguracion);
                        ...
                        try
                        {
                            ConexionBD.EjecutarProcedimientoReturnVoid("cliente_elimina", "pDocumento", dgvDatos.Rows[e.RowIndex].Cells[2].Value.ToString());
                            ConexionBD.COMMIT();
                            SeElimino = true;
                            listar();
                            tipo = Tipo.eliminar;
                        ...
                        if (SeElimino)
                            ...
                            MessageBox.Show("HUBO UN ERROR AL ELIMINAR EL CLIENTE, INTENTELO NUEVAMENTE", "AVISO", MessageBoxButtons.OK, MessageBoxIcon.Information);
