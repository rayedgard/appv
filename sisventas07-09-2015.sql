...
BEGIN
    ...
    SELECT id, nombre, precio, stock, stockminimo FROM producto WHERE estado =0 and (nombre=pFiltro OR nroserie=pFiltro);
END */$$
DELIMITER ;
