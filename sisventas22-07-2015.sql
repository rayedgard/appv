...
insert  into `descuento`(`id`,`criterio`,`idProducto`,`idTipoDescuento`,`fechaInicio`,`fechaFin`,`estado`) values (1,'categoria',1,1,'2015-03-10','2015-03-12',0),(2,'CATEGORIA',1,6,'2015-07-14','2015-07-14',0);
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `descuento_guarda`(pId INT(8),pCriterio char(200),pIdProducto int(8), pIdTipoDescuento int(8),pFechaIni date,pFechaFin date, pEstado INT(1))
BEGIN
    ...
    REPLACE INTO descuento VALUES(pId,pCriterio,pIdProducto,pIdTipoDescuento,pFechaIni,pFechaFin,pEstado);
...
BEGIN
    ...
    SELECT id,criterio,idProducto,idTipoDescuento,fechaInicio,fechaFin,estado
    FROM descuento
